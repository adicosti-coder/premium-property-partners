...
-- Drop the existing check constraint and recreate with sports category
...
CHECK (category IN ('restaurant', 'cafe', 'bar', 'shopping', 'attraction', 'transport', 'entertainment', 'health', 'sports'));
