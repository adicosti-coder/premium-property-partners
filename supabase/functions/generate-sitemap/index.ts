...
serve(async (req: Request) => {
  ...
  try {
    ...
    const staticPages = [
      ...
      { url: "/imobiliare-timisoara/zona-girocului", priority: "0.7", changefreq: "weekly" },
      { url: "/imobiliare-timisoara/zona-aradului", priority: "0.7", changefreq: "weekly" },
      { url: "/imobiliare-timisoara/circumvalatiunii", priority: "0.7", changefreq: "weekly" },
      { url: "/imobiliare-timisoara/sagului", priority: "0.7", changefreq: "weekly" },
      { url: "/imobiliare-timisoara/complex-studentesc", priority: "0.7", changefreq: "weekly" },
      { url: "/imobiliare-timisoara/calea-lipovei", priority: "0.7", changefreq: "weekly" },
      { url: "/imobiliare-timisoara/isho", priority: "0.7", changefreq: "weekly" },
      // Zone landing pages
