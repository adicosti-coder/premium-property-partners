...
export const RecoveryEmail = ({
  ...
  <Html lang="ro" dir="ltr">
    <Head />
    <Preview>Resetează parola pentru {siteName}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Am primit o cerere de resetare a parolei pentru contul tău {siteName}. Apasă butonul de mai jos pentru a alege o parolă nouă.
        </Text>
