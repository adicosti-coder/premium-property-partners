ALTER TABLE public.wa_publish_consents
  ADD COLUMN IF NOT EXISTS last_reply_notified_at timestamptz;

CREATE OR REPLACE FUNCTION public.get_keyword_scan_report_v2(
...
GRANT EXECUTE ON FUNCTION public.get_keyword_scan_report_v2(integer, text) TO authenticated;