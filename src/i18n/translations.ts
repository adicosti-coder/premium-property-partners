...
Mulțumesc!`,
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "You own the apartment. We turn it into monthly income — without you lifting a finger.\nFull hotel-grade operations by ApArt Hotel: guests, cleaning, pricing and reporting are on us.\n9.4% net yield, based on assumptions you can check: 75% occupancy, 27% deduction.",
