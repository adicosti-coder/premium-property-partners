...
Mulțumesc!`,
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "Real estate agency and ApArt Hotel management in Timișoara: investments, sales, rentals and short-term rental accommodation. 9.4% Verified Net ROI, 85% occupancy, 24/7 self check-in.",
      cta: "Find Your Yield",
