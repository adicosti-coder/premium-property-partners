export const translations = {
  ro: {
    ...
    ownerBenefits: {
      ...
      title: "Operare hotelieră,",
      titleHighlight: "venit predictibil",
      subtitle: "Trei avantaje care fac diferența între o chirie clasică și un apartament administrat ca un hotel de 5 stele: randament superior, transparență financiară totală și liniște operațională completă.",
      commission: "Comision de administrare",
      commissionValue: "15-25%",
      commissionSuffix: "din încasările nete, fără costuri ascunse",
      items: [
        { title: "Randament +40% vs. chirie clasică", description: "• Pricing dinamic AI\n• Optimizare sezonală\n• ROI net 9.4% verificat" },
        { title: "Transparență financiară totală", description: "• Dashboard live 24/7\n• RevPAR, ADR, ocupare\n• P&L detaliat lunar" },
        { title: "Operare hotelieră fără stres", description: "• Echipă dedicată 24/7\n• Curățenie hotelieră\n• Mentenanță gestionată" },
        { title: "Oaspeți verificați", description: "• Verificare ID completă\n• Istoric rezervări\n• Protecție proprietate" },
        { title: "Marketing premium inclus", description: "• Fotografii profesionale\n• Listare multi-canal\n• Optimizare conversie" },
        { title: "Concierge digital pentru oaspeți", description: "• Self check-in\n• Comunicare bilingvă\n• Follow-up post-sejur" },
        { title: "Standarde hoteliere certificate", description: "• Protocol housekeeping\n• Quality control\n• Linen premium" },
...
Mulțumesc!`,
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "You invest in real estate — we build you a turnkey business, through RealTrust Imobiliare.\nFull short-term rental management, hassle-free, through ApArt Hotel.\nYou collect, we handle everything.",
      cta: "Find Your Yield",
      ...
      features: {
        ...
        model: "Management",
        modelDesc: "All-inclusive, zero worries",
        response: "Support",
    ...
    ownerBenefits: {
      ...
      subtitle: "Three advantages that separate a plain rental from an apartment run like a 5-star hotel: superior yield, full financial transparency, and complete operational peace of mind.",
      commission: "Management fee",
      commissionValue: "15-25%",
      commissionSuffix: "of net income, no hidden costs",
      items: [
        { title: "+40% yield vs. classic rent", description: "• AI dynamic pricing\n• Seasonal optimization\n• Verified 9.4% net ROI" },
        { title: "Full financial transparency", description: "• Live dashboard 24/7\n• RevPAR, ADR, occupancy\n• Detailed monthly P&L" },
        { title: "Stress-free hotel operations", description: "• Dedicated 24/7 team\n• Hotel-grade cleaning\n• Maintenance handled" },
        { title: "Verified guests", description: "• Full ID verification\n• Booking history\n• Property protection" },
        { title: "Premium marketing included", description: "• Professional photos\n• Multi-channel listing\n• Conversion optimization" },
        { title: "Digital concierge for guests", description: "• Self check-in\n• Bilingual communication\n• Post-stay follow-up" },
        { title: "Certified hotel standards", description: "• Housekeeping protocol\n• Quality control\n• Premium linen" },
