export const translations = {
  ro: {
    ...
    hero: {
      ...
      title: "Transformăm proprietatea ta",
      titleMid: "într-o investiție",
      titleHighlight: "performantă și predictibilă.",
      subtitle: "Operare hotelieră 100% hands-off prin ApArt Hotel, cu randament net 9.4% verificat.\nTu deții activul, noi construim afacerea — vânzare, administrare și cazare premium prin RealTrust.\nZero implicare zilnică. Venit lunar transparent.",
      cta: "Calculează Randamentul Net",
      ctaSecondary: "Vreau o investiție performantă în Timișoara",
      ctaGuests: "Pentru Oaspeți",
      ctaQuickStart: "Start Rapid",
      trustTitle: "De Încredere Pentru",
      trustText: "Primești o simulare completă + recomandări personalizate în 24h",
