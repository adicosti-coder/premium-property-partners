...
Mulțumesc!`,
  ...
  en: {
    ...
    hero: {
      ...
      title: "We turn your property",
      titleMid: "into a high-performing,",
      titleHighlight: "predictable investment.",
      subtitle: "100% hands-off hotel-grade operations through ApArt Hotel, with a verified 9.4% net ROI.\nYou own the asset, we build the business — sales, management and premium stays through RealTrust.\nZero day-to-day involvement. Transparent monthly income.",
      cta: "Calculate Your Net Return",
      ...
      trustText: "You'll receive a complete simulation + personalized recommendations in 24h",
