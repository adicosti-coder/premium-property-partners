...
const ContactPage = () => {
  ...
  const faqItems = isRo
    ? [
        ...
        { q: "Cum ajung la sediul RealTrust din Timișoara?", a: "Sediul este în Strada Samuil Micu Nr.14, sector central — vis-à-vis de zona Iulius Town. Folosește butonul „Deschide în Google Maps” pentru rută." },
      ]
    : [
        ...
        { q: "How do I get to the RealTrust office in Timișoara?", a: "The office is at Strada Samuil Micu Nr.14, central area — near Iulius Town. Use the 'Open in Google Maps' button for directions." },
      ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description={isRo
          ? "Contactează echipa RealTrust Timișoara: sediu Str. Samuil Micu 14, telefon +40 799 069 256, hartă și program. Suntem aici pentru a te ajuta!"
          : "Contact the RealTrust Timișoara team: office Str. Samuil Micu 14, phone +40 799 069 256, map and hours. We're here to help!"}
        url={`${BASE_URL}/contact`}
