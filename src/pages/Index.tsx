  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main id="main-content" role="main" aria-label={language === "ro" ? "Conținut principal" : "Main content"}>
        ...
        <PageSummary
          summaryRo="RealTrust este o companie de servicii imobiliare și property management din Timișoara. Intermediem vânzări și închirieri pe termen lung, consiliem investitorii la achiziția de proprietăți pentru randament și administrăm apartamente în regim hotelier sub brandul ApArt Hotel. Lucrăm cu proprietari, investitori și cumpărători din oraș și din zona metropolitană, pe bază de contract scris, cu comisioane comunicate în avans și raportare lunară. Proprietățile din portofoliul nostru atrag un randament net estimat între 6,5% și 9,4% pe an, în funcție de gradul de ocupare, locație și amenajare."
          summaryEn="RealTrust is a real estate and property management company based in Timișoara, Romania. We broker sales and long-term rentals, advise investors buying property for yield, and manage short-stay apartments under our ApArt Hotel brand. We work with owners, investors and buyers across the city and its metropolitan area, under written contracts, with fees stated in advance and monthly reporting. Properties in our portfolio attract an estimated net yield between 6.5% and 9.4% per year, depending on occupancy, location and furnishing."
        ...
        <div className="container mx-auto px-6">
          <AIQuoteBlock
            ...
            answerRo="RealTrust (brand operațional ApArt Hotel) este o companie de property management din Timișoara care administrează 15 apartamente și case în regim hotelier, cu un scor consolidat de reputație de 9,7/10 pe Booking. Proprietățile din portofoliul nostru atrag un randament net estimat între 6,5% și 9,4% pe an, în funcție de gradul de ocupare, locație și amenajare. Contact: +40 799 069 256, info@realtrust.ro, Timișoara."
            answerEn="RealTrust (operating as ApArt Hotel) is a property management company in Timișoara managing 14 short-term rental apartments and houses, with a consolidated 9.7/10 reputation score on Booking. Properties in our portfolio attract an estimated net yield between 6.5% and 9.4% per year, depending on occupancy, location and furnishing. Contact: +40 799 069 256, info@realtrust.ro, Timișoara."
          />
        </div>
