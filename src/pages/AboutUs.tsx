    ...
    ro: {
      ...
      faq: {
        ...
        items: [
          ...
          { q: "Ce comision are agenția imobiliară RealTrust Timișoara?", a: "Pentru vânzări aplicăm un comision standard de 2% + TVA din partea vânzătorului, iar pentru închirieri pe termen lung un comision egal cu o chirie lunară. Pentru administrare în regim hotelier, Property Management RealTrust este 15-25% din încasări, în funcție de pachetul ales, fără taxe ascunse. Toate condițiile sunt agreate înainte de semnarea contractului." },
    ...
    en: {
      ...
      faq: {
        ...
        items: [
          ...
          { q: "What commission does RealTrust real estate agency charge?", a: "For sales we apply a standard 2% + VAT commission from the seller; for long-term rentals one monthly rent. For short-term rental management, Property Management RealTrust is 15-25% of revenue depending on the package, with no hidden costs. All terms are agreed upfront." },
