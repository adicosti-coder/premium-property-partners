...
export const countries: CountryInfo[] = [
  ...
  { code: 'HR', name: 'Croația', nameEn: 'Croatia', flag: '🇭🇷', prefix: '+385', phoneLength: 9, mobileStartDigits: ['9'] },
  { code: 'SI', name: 'Slovenia', nameEn: 'Slovenia', flag: '🇸🇮', prefix: '+386', phoneLength: 8, mobileStartDigits: ['3', '4', '5', '6', '7'] },
  { code: 'SK', name: 'Slovacia', nameEn: 'Slovakia', flag: '🇸🇰', prefix: '+421', phoneLength: 9, mobileStartDigits: ['9'] },
  ...
  { code: 'LU', name: 'Luxemburg', nameEn: 'Luxembourg', flag: '🇱🇺', prefix: '+352', phoneLength: 9, mobileStartDigits: ['6'] },
  ...
  { code: 'CY', name: 'Cipru', nameEn: 'Cyprus', flag: '🇨🇾', prefix: '+357', phoneLength: 8, mobileStartDigits: ['9'] },
  { code: 'MT', name: 'Malta', nameEn: 'Malta', flag: '🇲🇹', prefix: '+356', phoneLength: 8, mobileStartDigits: ['7', '9'] },
  
  // British Isles
  { code: 'UK', name: 'Marea Britanie', nameEn: 'United Kingdom', flag: '🇬🇧', prefix: '+44', phoneLength: 10, mobileStartDigits: ['7'] },
  { code: 'IE', name: 'Irlanda', nameEn: 'Ireland', flag: '🇮🇪', prefix: '+353', phoneLength: 9, mobileStartDigits: ['8'] },
  
  // Nordic Countries
  { code: 'SE', name: 'Suedia', nameEn: 'Sweden', flag: '🇸🇪', prefix: '+46', phoneLength: 9, mobileStartDigits: ['7'] },
  { code: 'NO', name: 'Norvegia', nameEn: 'Norway', flag: '🇳🇴', prefix: '+47', phoneLength: 8, mobileStartDigits: ['4', '9'] },
  { code: 'DK', name: 'Danemarca', nameEn: 'Denmark', flag: '🇩🇰', prefix: '+45', phoneLength: 8, mobileStartDigits: ['2', '3', '4', '5', '6', '7', '8', '9'] },
  { code: 'FI', name: 'Finlanda', nameEn: 'Finland', flag: '🇫🇮', prefix: '+358', phoneLength: 9, mobileStartDigits: ['4', '5'] },
  { code: 'IS', name: 'Islanda', nameEn: 'Iceland', flag: '🇮🇸', prefix: '+354', phoneLength: 7, mobileStartDigits: ['6', '7', '8'] },
  ...
  { code: 'LT', name: 'Lituania', nameEn: 'Lithuania', flag: '🇱🇹', prefix: '+370', phoneLength: 8, mobileStartDigits: ['6'] },
  { code: 'LV', name: 'Letonia', nameEn: 'Latvia', flag: '🇱🇻', prefix: '+371', phoneLength: 8, mobileStartDigits: ['2'] },
  { code: 'EE', name: 'Estonia', nameEn: 'Estonia', flag: '🇪🇪', prefix: '+372', phoneLength: 8, mobileStartDigits: ['5'] },
  
  // Turkey & Middle East
  { code: 'TR', name: 'Turcia', nameEn: 'Turkey', flag: '🇹🇷', prefix: '+90', phoneLength: 10, mobileStartDigits: ['5'] },
  { code: 'IL', name: 'Israel', nameEn: 'Israel', flag: '🇮🇱', prefix: '+972', phoneLength: 9, mobileStartDigits: ['5'] },
  { code: 'AE', name: 'Emiratele Arabe', nameEn: 'UAE', flag: '🇦🇪', prefix: '+971', phoneLength: 9, mobileStartDigits: ['5'] },
  
  // Americas
  { code: 'US', name: 'SUA', nameEn: 'United States', flag: '🇺🇸', prefix: '+1', phoneLength: 10 },
  { code: 'CA', name: 'Canada', nameEn: 'Canada', flag: '🇨🇦', prefix: '+1', phoneLength: 10 },
  
  // Asia-Pacific
  { code: 'AU', name: 'Australia', nameEn: 'Australia', flag: '🇦🇺', prefix: '+61', phoneLength: 9, mobileStartDigits: ['4'] },
  { code: 'NZ', name: 'Noua Zeelandă', nameEn: 'New Zealand', flag: '🇳🇿', prefix: '+64', phoneLength: 9, mobileStartDigits: ['2'] },
];
