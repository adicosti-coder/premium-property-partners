...
export const properties: Property[] = [
  {
    ...
    imageAlts: [
      ...
      "Bucătărie complet utilată RING ApArt Hotel, design modern",
      "Baie modernă cu duș RING ApArt Hotel Timișoara",
      "Zonă de dining RING ApArt Hotel cu masă pentru 4 persoane",
      "Vedere panoramică de pe terasă RING ApArt Hotel",
      "Hol de intrare elegant RING ApArt Hotel Timișoara",
    ],
    imageAltsEn: [
      ...
      "Fully equipped kitchen RING ApArt Hotel, modern design",
      "Modern bathroom with shower RING ApArt Hotel Timișoara",
      "Dining area RING ApArt Hotel with table for 4",
      "Panoramic view from terrace RING ApArt Hotel",
      "Elegant entrance hall RING ApArt Hotel Timișoara",
    ],
