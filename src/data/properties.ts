...
export const properties: Property[] = [
  ...
  },
  {
    ...
    features: ["105 mp", "Două Niveluri", "Ideal Familii"],
    featuresEn: ["105 sqm", "Two Levels", "Family Friendly"],
    bookingUrl: "https://cross-square-house.pynbooking.direct/",
    description: "Reședință de 105 mp pe două niveluri, în inima Timișoarei — spațiu generos pentru familii",
    descriptionEn: "105 sqm two-level residence in the heart of Timișoara — generous space for families",
    longDescription: "Cross Square House by RealTrust, pe Str. 1 Decembrie 1918 nr. 38, oferă 105 mp distribuiți pe două niveluri, în inima Timișoarei. Spațiu generos pentru familii sau grupuri, bucătărie complet utilată, WiFi de mare viteză și auto check-in, la câțiva pași de centrul istoric.",
    longDescriptionEn: "Cross Square House by RealTrust, on Str. 1 Decembrie 1918 no. 38, offers 105 sqm spread over two levels in the heart of Timișoara. Generous space for families or groups, a fully equipped kitchen, high-speed WiFi and self check-in, steps from the historic centre.",
    rating: 9.6,
    reviews: 68,
    capacity: 6,
    bedrooms: 2,
