...
export const properties: Property[] = [
  {
    ...
    name: "RING Family Residence - Spacious 2 BR Apartment",
    location: "Str. Loichița Vasile 1-3, Timișoara",
    images: [apt09, pyn(19,7392,63400), pyn(19,7392,63461), pyn(19,7392,63401), pyn(19,7392,63402), pyn(19,7392,63403), pyn(19,7392,63460), pyn(19,7392,63462)],
    imageAlts: [
      "Living spațios RING Family Residence cu canapea extensibilă, Timișoara",
      "Dormitor modern dublu RING Family Residence Timișoara",
      "Terasă mare cu mobilier de exterior RING Family Residence",
      "Bucătărie complet utilată RING Family Residence, design modern",
      "Baie cu cadă și duș RING Family Residence Timișoara",
      "Zonă de dining RING Family Residence cu masă pentru 4 persoane",
      "Vedere panoramică de pe terasă RING Family Residence",
      "Hol de intrare elegant RING Family Residence Timișoara",
    ],
    imageAltsEn: [
      "Spacious living room RING Family Residence with sofa bed, Timișoara",
      "Modern double bedroom RING Family Residence Timișoara",
      "Large terrace with outdoor furniture RING Family Residence",
      "Fully equipped kitchen RING Family Residence, modern design",
      "Bathroom with tub and shower RING Family Residence Timișoara",
      "Dining area RING Family Residence with table for 4",
      "Panoramic view from terrace RING Family Residence",
      "Elegant entrance hall RING Family Residence Timișoara",
    ],
    features: ["Cadă & Duș", "Terasă", "Parcare Subterană"],
    featuresEn: ["Tub & Shower", "Terrace", "Underground Parking"],
    bookingUrl: "https://k3y.in/t5BJj",
    description: "Apartament spațios cu 2 dormitoare, cadă și duș, terasă și parcare subterană gratuită",
    descriptionEn: "Spacious 2 BR apartment with tub and shower, terrace and free underground parking",
    longDescription: "RING Family Residence pe Strada Loichița Vasile 1-3 oferă un apartament spațios cu 2 dormitoare, baie cu cadă și duș, terasă și parcare subterană gratuită. Ideal pentru familii sau grupuri de până la 4 persoane care caută confort și intimitate în Timișoara.",
    longDescriptionEn: "RING Family Residence on Strada Loichița Vasile 1-3 offers a spacious 2 BR apartment with a bathroom featuring both tub and shower, a terrace and free underground parking. Ideal for families or groups of up to 4 people looking for comfort and privacy in Timișoara.",
    rating: 9.7,
    reviews: 28,
    capacity: 4,
    bedrooms: 2,
    bathrooms: 1,
    size: 80,
    amenities: ["WiFi de mare viteză", "Smart TV 55\"", "Aer condiționat", "Mașină de spălat", "Bucătărie complet utilată", "Parcare subterană gratuită", "Auto check-in", "Cadă și duș", "Terasă", "Lenjerie premium"],
    amenitiesEn: ["High-speed WiFi", "55\" Smart TV", "Air conditioning", "Washing machine", "Fully equipped kitchen", "Free underground parking", "Self check-in", "Tub and shower", "Terrace", "Premium linens"],
