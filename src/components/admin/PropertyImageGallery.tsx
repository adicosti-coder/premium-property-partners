    ...
    >
      ...
      {!isSelectionMode && (
        <div
          {...attributes}
          {...listeners}
          className="absolute top-1 left-1 z-10 p-1.5 bg-background/80 rounded cursor-grab active:cursor-grabbing opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity touch-none"
        >
