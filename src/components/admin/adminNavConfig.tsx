...
export const ADMIN_GROUPS: AdminGroup[] = [
  ...
  },
  {
    ...
    label: "AI & Scraper",
    icon: Sparkles,
    subgroupOrder: ["AI Tools", "WhatsApp & Andrei", "Booking", "Scraper Pipeline"],
    items: [
      ...
      { value: "whatsapp-live", label: "Conversații live", icon: MessageSquare, subgroup: "WhatsApp & Andrei", keywords: ["whatsapp", "conversatii", "live", "discutii", "chat", "client", "agent", "fir"] },
      { value: "whatsapp-chat", label: "Chat WhatsApp", icon: MessageSquare, subgroup: "WhatsApp & Andrei", keywords: ["chat", "whatsapp", "trimite", "mesaj", "agent", "client", "direct", "raspuns"] },
      { value: "whatsapp-threads", label: "Discuții", icon: MessageSquare, subgroup: "WhatsApp & Andrei", keywords: ["discutii", "fir", "thread", "chat", "whatsapp", "client", "agent", "istoric", "oferta"] },
      { value: "whatsapp-live-dashboard", label: "Dashboard conversații live", icon: MessageSquare, subgroup: "WhatsApp & Andrei", keywords: ["whatsapp", "dashboard", "live", "primite", "raspunsuri", "abandonate", "blocaj", "agent"] },
      { value: "whatsapp-daily-emails", label: "E-mailuri zilnice", icon: MessageSquare, subgroup: "WhatsApp & Andrei", keywords: ["email", "emailuri", "zilnice", "digest", "rezumat", "backup", "fir", "conversatii", "whatsapp"] },
      { value: "make-status", label: "Stare Make", icon: MessageSquare, subgroup: "WhatsApp & Andrei", keywords: ["make", "scenariu", "stare", "status", "ultima rulare", "livrate", "esuate", "re-run", "webhook"] },
      { value: "whatsapp-analytics", label: "Analiză conversații", icon: MessageSquare, subgroup: "WhatsApp & Andrei", keywords: ["whatsapp", "conversatii", "analiza", "grafic", "livrate", "esuate", "abandonate", "zile", "dashboard"] },
      { value: "whatsapp-sources", label: "Surse & durată discuții", icon: MessageSquare, subgroup: "WhatsApp & Andrei", keywords: ["whatsapp", "sursa", "surse", "durata", "anunt", "contact", "recontactare", "agent", "discutii"] },
      { value: "whatsapp-transactions", label: "Tranzacții WhatsApp", icon: MessageSquare, subgroup: "WhatsApp & Andrei", keywords: ["whatsapp", "tranzactii", "apartament", "anunt", "vanzare", "dashboard", "grafic"] },
      ...
      { value: "booking-reviews", label: "Recenzii Booking", icon: Star, subgroup: "Booking", keywords: ["booking", "recenzii", "note", "rating", "review", "oaspeti"] },
