...
export const ADMIN_GROUPS: AdminGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { value: "whatsapp-history", label: "Istoric WhatsApp", icon: MessageSquare, subgroup: "AI Tools", keywords: ["whatsapp", "istoric", "mesaje", "trimise", "erori", "meta", "log"] },
      ...
      { value: "whatsapp-chat", label: "Chat WhatsApp", icon: MessageSquare, subgroup: "AI Tools", keywords: ["chat", "whatsapp", "trimite", "mesaj", "agent", "client", "direct", "raspuns"] },
      { value: "whatsapp-threads", label: "Discuții", icon: MessageSquare, subgroup: "AI Tools", keywords: ["discutii", "fir", "thread", "chat", "whatsapp", "client", "agent", "istoric", "oferta"] },
      ...
      { value: "whatsapp-meetings", label: "Vizite confirmate", icon: CalendarDays, subgroup: "AI Tools", keywords: ["vizite", "vizionare", "confirmate", "data", "ora", "apartament", "intalnire", "whatsapp"] },
