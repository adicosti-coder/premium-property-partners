      ...
      services: [
        {
          ...
          description: "Management complet și administrare apartamente în regim hotelier pentru proprietari și investitori",
          link: "#calculator",
        ...
        },
        {
          ...
          description: "Apartamente echipate complet pentru oaspeți — cazare în regim hotelier la standarde înalte",
          link: "/oaspeti",
        ...
        {
          icon: Home,
          title: "Agenție Imobiliară",
          description: "Vânzări, închirieri și investiții imobiliare în Timișoara — consultanță și intermediere",
          link: "/imobiliare",
          cta: "Explorează Imobiliare",
          color: "from-green-500/20 to-green-600/10",
        },
        {
          icon: FileText,
          title: "Blog & Ghiduri",
          description: "Articole și sfaturi despre investiții, administrare și regim hotelier",
          link: "/blog",
      ...
      services: [
        {
          ...
          description: "Complete property management and administration for owners and investors",
          link: "#calculator",
        ...
        },
        {
          icon: Key,
          title: "Premium Stays",
          description: "Fully equipped apartments for guests — high-standard short-term rental accommodation",
          link: "/oaspeti",
          cta: "View Apartments",
          color: "from-blue-500/20 to-blue-600/10",
        },
        {
          ...
          description: "Sales, rentals and real estate investments in Timișoara — consulting and brokerage",
          link: "/imobiliare",
        ...
        },
        {
          icon: FileText,
          title: "Blog & Guides",
          description: "Articles and tips about investments, management and short-term rentals",
          link: "/blog",
          cta: "Read Articles",
          color: "from-purple-500/20 to-purple-600/10",
        },
