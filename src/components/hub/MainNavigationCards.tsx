...
const MainNavigationCards = () => {
  ...
  const content = {
    ro: {
      badge: "Explorează serviciile",
      title: "Tot ce ai nevoie,",
      titleHighlight: "într-un singur loc",
      subtitle: "Alege serviciul potrivit pentru obiectivul tău — proprietar, oaspete sau investitor.",
      primaryCards: [
        {
          icon: Building2,
          title: "Administrare proprietăți",
          description: "Listare, oaspeți, curățenie și raportare.\nUn singur partener, randament net țintă 9,4%.",
          cta: "Vezi cum administrăm",
        ...
        },
        {
          ...
          description: "Apartamente complet echipate, self check-in 24/7.\nRezervare directă, fără comision suplimentar.",
        ...
        },
        {
          ...
          description: "Evaluări obiective și pași clari pentru fiecare etapă.\nNegociem în interesul tău.",
          cta: "Vezi serviciile",
          link: "/imobiliare",
        ...
        },
        {
          ...
          description: "Catalog verificat, analiză ROI și deal-room.\nDecizii bazate pe date, nu pe promisiuni.",
          cta: "Vezi oportunitățile",
          link: "/investitii",
    ...
    en: {
      badge: "Explore the services",
      title: "Everything you need,",
      titleHighlight: "in one place",
      subtitle: "Pick the service that matches your goal — owner, guest or investor.",
      primaryCards: [
        {
          icon: Building2,
          title: "Property management",
          description: "Listing, guests, cleaning and reporting.\nOne partner, 9.4% target net yield.",
          cta: "See how we manage",
          link: "/pentru-proprietari",
          accent: "from-amber-500/20 to-amber-600/5",
        },
        {
          ...
          description: "Fully-equipped apartments, 24/7 self check-in.\nDirect booking, no extra fees.",
          cta: "View apartments",
          link: "/oaspeti",
          accent: "from-blue-500/20 to-blue-600/5",
        },
        {
          ...
          description: "Objective valuations and clear steps for every stage.\nWe negotiate in your interest.",
        ...
        },
        {
          ...
          description: "Verified catalog, ROI analysis and deal-room.\nDecisions based on data, not promises.",
