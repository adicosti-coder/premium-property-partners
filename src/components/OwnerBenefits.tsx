...
const OwnerBenefits = () => {
  ...
  return (
    <section className="py-24 bg-secondary relative overflow-hidden">
      ...
      {/* Decorative elements with parallax - offset to prevent visible overflow */}
      <div 
        className="absolute top-0 -right-48 w-96 h-96 bg-primary/10 rounded-full blur-3xl transition-transform duration-100"
        style={{ transform: `translateY(${parallaxOffset1}px)` }}
      />
      <div 
        className="absolute bottom-0 -left-48 w-96 h-96 bg-primary/10 rounded-full blur-3xl transition-transform duration-100"
