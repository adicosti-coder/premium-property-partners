  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-sans",
  {
    variants: {
      variant: {
        ...
        whatsapp: "bg-whatsapp text-whatsapp-foreground font-semibold hover:bg-whatsapp-hover shadow-lg hover:shadow-xl hover:scale-105",
        call: "bg-primary text-primary-foreground font-semibold hover:bg-primary/90",
        booking: "bg-booking-blue text-white font-semibold hover:bg-booking-blue-hover shadow-md hover:shadow-lg",
      },
      size: {
