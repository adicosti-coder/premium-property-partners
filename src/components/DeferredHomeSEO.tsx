...
const DeferredHomeSEO = ({ language }: { language: string }) => {
  ...
  const homepageFaqItems = [
    ...
    { question: language === "ro" ? "Ce cartiere din Timișoara sunt cele mai profitabile pentru investiții imobiliare?" : "Which neighborhoods in Timișoara are most profitable for real estate investments?",
      answer: language === "ro" ? "Cele mai profitabile cartiere pentru regim hotelier sunt: Cetate / Centrul Vechi (ocupare 75-85%), Complex Studențesc (cerere constantă de la UVT, UPT, UMF), ISHO (premium, ADR ridicat) și Iosefin (mix turism + business). ROI net estimat 8-10%." : "The most profitable neighborhoods for hotel regime are: Cetate / Old Town (75-85% occupancy), Complex Studențesc (constant demand from UVT, UPT, UMF), ISHO (premium, high ADR) and Iosefin (tourism + business mix). Estimated net ROI 8-10%." },
