    ...
    <>
      ...
      <div className="flex items-center gap-4 mt-4">
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-[#128C7E] hover:bg-[#0e7a6e] text-white rounded-lg font-medium text-sm transition-all hover:scale-105 shadow-md"
        >
