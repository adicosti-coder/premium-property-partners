        ...
        {(() => {
          ...
          return (
            <picture>
              ...
              <img
                src={imgSrc}
                alt="Imobiliare și Apart-hotel management complet în Timișoara: vânzări, cumpărări, închirieri, amenajări și administrare de apartamente în regim hotelier. ROI 9%+, ocupare 85%, self check-in 24/7"
    ...
    <>
      ...
      <div className="flex items-center gap-4 mt-4">
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-whatsapp hover:bg-whatsapp-hover text-whatsapp-foreground rounded-lg font-medium text-sm transition-all hover:scale-105 shadow-md"
        >
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-white text-foreground rounded-lg text-sm font-medium shadow-md hover:shadow-lg transition-all hover:scale-105"
        >
