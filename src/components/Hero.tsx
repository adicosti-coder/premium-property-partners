    ...
    <>
      ...
      <div className="flex items-center gap-4 mt-4">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-white text-gray-900 rounded-lg text-sm font-medium shadow-md hover:shadow-lg transition-all hover:scale-105"
        >
