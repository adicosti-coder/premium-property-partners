...
const FinancialTransparency = () => {
    ...
    ro: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: "La finalul lunii, îți trimitem factura pentru comisionul de administrare de 15-25% din încasările nete",
    ...
    en: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: "At the end of the month, we send you the invoice for the 15-25% management commission of net income",
  ...
  return (
    <section className="py-20 md:py-28 bg-gradient-to-b from-background via-primary/5 to-background relative overflow-hidden">
      {/* Background decoration - offset to prevent visible overflow */}
