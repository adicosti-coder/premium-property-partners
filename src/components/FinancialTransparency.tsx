    ...
    ro: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: "La finalul lunii, îți trimitem factura pentru comisionul de administrare de 20%",
    ...
    en: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: "At the end of the month, we send you the invoice for the 20% management commission",
