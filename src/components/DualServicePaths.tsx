      ...
      paths: [
        {
          icon: Home,
          accent: "blue",
          question: "Vinzi, cumperi sau închiriezi?",
          subtitle: "Servicii imobiliare complete în Timișoara",
          description: "Intermediem tranzacții de vânzare, cumpărare și închiriere pentru apartamente, case și spații comerciale — cu evaluare de piață, suport juridic și un consultant alocat.",
          benefits: ["Evaluare de piață pe date reale", "Contracte și suport juridic", "Promovare profesională a proprietății"],
          cta: "Vreau servicii imobiliare",
          link: "/imobiliare",
        },
        {
          icon: TrendingUp,
          ...
          description: "Te ghidăm de la achiziție la amenajare și operare — cu analize de randament reale, strategii de maximizare și acces la oferte premium din proiecte noi.",
      ...
      paths: [
        {
          icon: Home,
          accent: "blue",
          question: "Selling, buying or renting?",
          subtitle: "End-to-end real estate services in Timișoara",
          description: "We broker sales, purchases and long-term rentals for apartments, houses and commercial spaces — with market valuation, legal support and one dedicated consultant.",
          benefits: ["Market valuation on real data", "Contracts and legal support", "Professional property marketing"],
          cta: "I want real estate services",
          link: "/imobiliare",
        },
        {
          icon: TrendingUp,
          ...
          description: "We guide you from acquisition to setup and operation — with real yield analysis, maximization strategies, and premium deal access in new developments.",
