...
const FloatingWhatsApp = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className={cn(
        "fixed bottom-6 right-4 z-40 w-14 h-14 rounded-full bg-whatsapp text-whatsapp-foreground shadow-lg hover:shadow-xl hover:scale-110 flex items-center justify-center animate-pulse-glow",
