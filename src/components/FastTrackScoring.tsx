            ...
            {isLoading && !report ? (
              ...
              <>
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="whatsapp" size="sm" className="flex-1 gap-1" onClick={() => window.open(`https://wa.me/40723154520?text=${encodeURIComponent(`Scor AI: ${report.scor}/${report.max_scor} | ROI: ${report.roi_estimat} | ${report.tarif_noapte}€/noapte`)}`)}>
